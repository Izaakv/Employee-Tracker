    ...
    inquirer.prompt([
        {
            ...
            choices: ['View all departments', 'View all roles', 'View all employees', 'View all employees by manager', 'Add a department', 'Add a role', 'Add an employee', 'View total salary of department', 'Exit program']
        }
    ]).then((response) => {
